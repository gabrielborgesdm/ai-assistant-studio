...
export const AssistantForm = ({
  assistant,
}: AssistantFormProps): React.ReactElement => {
  const {
    errors,
    selectedModel,
    control,
  ...
  return (
    <div className="space-y-4">
      <form onSubmit={handleSubmit(onSubmit)}>
              ...
              <AccordionContent>
                ...
                <FormGroup>
                  ...
                  <Description>
                    ...
                    <strong>
                      This description can be used to automatically generate the
                      assistant's instructions and behavior.
                    </strong>
                  </Description>
                ...
                <FormSection>
                  <FormGroup>
                    <div className="flex items-center justify-between max-w-full">
                      <Label htmlFor="systemBehaviour">
                        Assistant Behaviour (Optional)
                      </Label>
                      <GenerateBehaviourButton
                        ...
                        autoGenerateAssistant={
                          systemBehaviourAutoGenerateAssistant
                        }
                        control={control}
                        setValue={setValue}
                    ...
                    <InputError
                      error={errors.systemBehaviour?.message as string}
                    />
                    <Description>
                      Define how the assistant should behave during
                      conversations. This sets its personality, tone, and
                      general context for responses.
                    </Description>
                  </FormGroup>
                  <FormGroup>
                    <div className="flex items-center justify-between max-w-full">
                    ...
                    <div className="space-y-1">
                      {ephemeral ? (
                        <Description>
                          This instruction will be combined with the user's
                          input every time they send a message.
                        </Description>
                      ) : (
                        <Description>
                          This instruction will be combined with the user's
                          input the first time they send a message.
                        </Description>
                      )}
                      <p className="text-xs text-muted-foreground italic">
                        ...
                        to define where the user’s message will be inserted. If
                        not provided, it will be appended at the end.
                      </p>
                    </div>
        ...
        <Button
          type="submit"
          className="ml-auto mt-4 align-right w-full"
          disabled={isLoading}
        >
          Save Assistant
        </Button>
