...
const OllamaModelSelector = ({
  ...
  return (
    <FormGroup>
      ...
      <Description>
        Choose the latest version of the Ollama Model or select a specific
        variant. Ollama models define the capabilities and behavior of the
        assistant.&nbsp;
        <a
      ...
      <Description>
        <strong>Note:</strong> Models with more parameters (e.g., 70B) typically
        provide better performance and understanding, but may run slower due to
        their size. For most cases, it's best to choose the{" "}
        <strong>latest version</strong> of a model, as it offers a good balance
